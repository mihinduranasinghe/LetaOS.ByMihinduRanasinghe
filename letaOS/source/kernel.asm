...
; ==================================================================
	...
	BITS 16
	%DEFINE LetaOS_VER '1.0.0'	 ;OS version number
	%DEFINE LetaOS_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
os_main:
	...
	mov es, ax			; segments ever again, as LetaOS and its programs
...
option_screen:
	...
	os_init_msg		db 'Welcome to Leta OS', 0
	os_version_msg		db 'Version ', LetaOS_VER, 0
...
option_screen2:
	...
	mov cx, 011001000011110		; Colour: white text on light blue
	call os_draw_background
	...
	os_init_msg3		db 'Welcome to Leta OS', 0
	os_version_msg3		db 'Version ', LetaOS_VER, 0

	dialog_string_7		db 'MIHINDUs LetaOS !', 0
	dialog_string_8		db 'Click HDD INFO to see your HARDWARE INFORMATION', 0
	dialog_string_9		db 'Click BACK button to go back to the home screen', 0
